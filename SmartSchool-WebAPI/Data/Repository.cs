...
namespace SmartSchool_WebAPI.Data
{
    public class Repository : IRepository
    {
        ...
        Task<Aluno[]> IRepository.GetAllAlunosAsync(bool includeProfessor)
        {
            throw new System.NotImplementedException();
        }

        Task<Aluno[]> IRepository.GetAlunosAsyncByDisciplinaId(int disciplinaId, bool includeDisciplina)
        {
            throw new System.NotImplementedException();
        }

        Task<Aluno> IRepository.GetAlunoAsyncById(int alunoId, bool includeProfessor)
        {
            throw new System.NotImplementedException();
        }

        Task<Professor[]> IRepository.GetAllProfessoresAsync(bool includeAluno)
        {
            throw new System.NotImplementedException();
        }

        Task<Professor> IRepository.GetProfessorAsyncById(int professorId, bool includeAluno)
        {
            throw new System.NotImplementedException();
        }

        Task<Professor[]> IRepository.GetProfessoresAsyncByAlunoId(int alunoId, bool includeDisciplina)
        {
            throw new System.NotImplementedException();
        }
    }
